...
`);
    ...
    var O = /* @__PURE__ */ function() {
      ...
      return function(n, i, o, s, a, l) {
        var u, c, p, d, f, y, g, P, T, C, x, R, ce, J, Ke, $, z2, Ae, Y, tt, hr = n.constructor, An = n.s == i.s ? 1 : -1, Z = n.d, k = i.d;
        if (!Z || !Z[0] || !k || !k[0])
          return new hr(!n.s || !i.s || (Z ? k && Z[0] == k[0] : !k) ? NaN : Z && Z[0] == 0 || !k ? An * 0 : An / 0);
        for (l ? (f = 1, c = n.e - i.e) : (l = ge, f = b, c = ee(n.e / f) - ee(i.e / f)), Y = k.length, z2 = Z.length, T = new hr(An), C = T.d = [], p = 0; k[p] == (Z[p] || 0); p++)
          ;
        if (k[p] > (Z[p] || 0) && c--, o == null ? (J = o = hr.precision, s = hr.rounding) : a ? J = o + (n.e - i.e) + 1 : J = o, J < 0)
          C.push(1), y = true;
        else {
          if (J = J / f + 2 | 0, p = 0, Y == 1) {
            for (d = 0, k = k[0], J++; (p < z2 || d) && J--; p++)
              Ke = d * l + (Z[p] || 0), C[p] = Ke / k | 0, d = Ke % k | 0;
            y = d || p < z2;
          } else {
            for (d = l / (k[0] + 1) | 0, d > 1 && (k = e(k, d, l), Z = e(Z, d, l), Y = k.length, z2 = Z.length), $ = Y, x = Z.slice(0, Y), R = x.length; R < Y; )
              x[R++] = 0;
        ...
        for (let T = 0; T < P.length; ++T) {
          ...
          for (let $ = n, z2 = i; $ < t.length; z2 += t[$].length, ++$) {
            ...
            if (ce && $ != t.length - 1) {
              ...
              if (t[$] instanceof ye)
                continue;
              u = a - $, Ae = e.slice(z2, l), p.index -= z2;
            } else {
              C.lastIndex = 0;
              var p = C.exec(Ae), u = 1;
            }
            ...
            if (Y.push(tt), y && Y.push(y), Array.prototype.splice.apply(t, Y), u != 1 && v.matchGrammar(e, t, r, $, z2, true, g), o)
              break;
          }
        }
      }
